...
import com.mrokga.carrot_server.dto.response.ProductDetailResponseDto;
...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query("""
        SELECT new com.mrokga.carrot_server.dto.response.ProductDetailResponseDto(
            p.title, p.description, p.user.nickname, p.region.name, p.category.name,
